...
func (_m *Service) GetAdminById(data admin.AdminCore) (admin.AdminCore, error) {
	ret := _m.Called(data)
...
func (_m *Service) GetAdmins() ([]admin.AdminCore, error) {
	ret := _m.Called()
...
// LoginAdmin provides a mock function with given fields: data
func (_m *Service) LoginAdmin(data admin.AdminCore) (admin.AdminCore, error) {
	ret := _m.Called(data)
...
// RegisterAdmin provides a mock function with given fields: data
func (_m *Service) RegisterAdmin(data admin.AdminCore) error {
	ret := _m.Called(data)
